...
| **`IssuanceConfig`**                   |          |                                                       |                                                   |                           |
| `issuance`                             |          | `IssuanceConfig`                                      | Issuance configuration                            |                           |
| **`IssuerConfig`**                     |          |                                                       |                                                   |                           |
| `issuance.issuer`                      |          | `IssuerConfig[]`                                      | Issuer configuration                              |                           |
| `issuance.issuer[].holderId`           |          | `String`                                              | DID of the holder                                 |                           |
| `issuance.issuer[].credentialType`     |          | `String`                                              | Credential type to be issued                      |                           |
| `issuance.issuer[].credentialSubject`  |          | `Object`                                              | Credential subject                                |                           |
| `issuance.issuer[].preAuthorizedCode`  | Yes      | `String`                                              | Pre-authorized code                               |                           |
| **`DCPHolderConfig`**                  |          |                                                       |                                                   |                           |
| `issuance.dcp`                         |          | `DCPHolderConfig[]`                                   | DCP Holder configuration                          |                           |
| `issuance.dcp[].preAuthorizedCode`     |          | `String`                                              | Pre-authorized code                               |                           |
| `issuance.dcp[].issuerId`              |          | `String`                                              | DID identifier of the issuer                      |                           |
| `issuance.dcp[].credentialType`        |          | `String`                                              | Credential type to be issued                      |                           |
| **`OID4VCIHolderConfig`**              |          |                                                       |                                                   |                           |
| `issuance.oid4vci`                     |          | `OID4VCIHolderConfig[]`                               | OID4VCI Holder configuration                      |                           |
| `issuance.oid4vci[].preAuthorizedCode` |          | `String`                                              | Pre-authorized code                               |                           |
| `issuance.oid4vci[].issuerUrl`         |          | `URL`                                                 | Root URL of the issuer                            |                           |
| `issuance.oid4vci[].credentialType`    |          | `String`                                              | Credential type(s) to be issued                   |                           |
| **`DidServiceConfig`**                 |          |                                                       |                                                   |                           |
