  ...
  apisidebar: [
    ...
    },
    {
      ...
      items: [
        {
          type: "doc",
          id: "apis/sso-bridge/roles-controller-get-roles",
          label: "Get all roles",
          className: "api-method get",
        },
        {
          type: "doc",
          id: "apis/sso-bridge/roles-controller-create-user",
          label: "Create a new role",
          className: "api-method post",
        },
        {
          type: "doc",
          id: "apis/sso-bridge/roles-controller-delete-role",
          label: "Delete a role",
          className: "api-method delete",
        },
        {
          type: "doc",
          id: "apis/sso-bridge/roles-controller-update-role",
