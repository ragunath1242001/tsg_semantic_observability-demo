...
This folder contains all the documentation that is available for the TNO Security Gateway. It is divided into apps folders for each component. The design choices below are valid for all components that are in the apps folder.
