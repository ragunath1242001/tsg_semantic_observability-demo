...
The default deployment strategies are formed around the [TSG CLI tool](../../tools/cli/). With this CLI tool configuration bootstrapping and deployment can be done for both:
