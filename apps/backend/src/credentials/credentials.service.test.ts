...
describe("Credentials Service", () => {
  ...
  describe("Credentials CRUD", () => {
    ...
    it("Request Gaia LRN", async () => {
      const credential =
        await credentialsService.requestLegalRegistrationNumberCredential(
      ...
      await expect(
        credentialsService.requestLegalRegistrationNumberCredential(
          {
            vcId: "LRN",
    ...
    it("Request Gaia Compliance", async () => {
      const credential = await credentialsService.requestComplianceCredential(
      ...
      await expect(
        credentialsService.requestComplianceCredential(
          {
            vcId: "Compliance",
