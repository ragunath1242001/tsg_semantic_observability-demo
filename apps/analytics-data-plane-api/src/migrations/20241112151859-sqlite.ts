...
export class Sqlite20241112151859 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "data_plane_state_dao" ("identifier" varchar PRIMARY KEY NOT NULL, "details" text NOT NULL, "dataset" text NOT NULL)`
    );
    await queryRunner.query(
      `CREATE TABLE "transfer_dao" ("id" varchar PRIMARY KEY NOT NULL, "role" varchar NOT NULL, "processId" varchar NOT NULL, "remoteParty" varchar NOT NULL, "datasetId" varchar NOT NULL, "secret" varchar, "state" varchar CHECK( "state" IN ('dspace:REQUESTED','dspace:STARTED','dspace:TERMINATED','dspace:COMPLETED','dspace:SUSPENDED') ) NOT NULL, "request" text NOT NULL, "response" text NOT NULL, "dataAddress" text, "createdDate" varchar NOT NULL DEFAULT (datetime('now')), "modifiedDate" varchar NOT NULL DEFAULT (datetime('now')), "deletedDate" varchar)`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "egress_log_dao" ("identifier" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "date" varchar NOT NULL DEFAULT (datetime('now')), "remoteParty" varchar(100) NOT NULL, "transferId" varchar(100) NOT NULL, "datasetId" varchar(100) NOT NULL, "path" varchar(100) NOT NULL, "method" varchar(10) NOT NULL, "status" smallint NOT NULL, "debug" text)`
    );
    await queryRunner.query(
