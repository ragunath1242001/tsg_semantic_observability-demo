...
export class Sqlite20250819141301 implements MigrationInterface {
    name = 'Sqlite20250819141301'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_dataplanedetails"("createdDate", "modifiedDate", "deletedDate", "identifier", "created", "modified", "health", "missedHealthChecks", "etag", "dataplaneType", "endpointPrefix", "callbackAddress", "managementAddress", "managementToken", "catalogSynchronization", "role") SELECT "createdDate", "modifiedDate", "deletedDate", "identifier", "created", "modified", "health", "missedHealthChecks", "etag", "dataplaneType", "endpointPrefix", "callbackAddress", "managementAddress", "managementToken", "catalogSynchronization", "role" FROM "dataplanedetails"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "dataplanedetails"("createdDate", "modifiedDate", "deletedDate", "identifier", "created", "modified", "health", "missedHealthChecks", "etag", "dataplaneType", "endpointPrefix", "callbackAddress", "managementAddress", "managementToken", "catalogSynchronization", "role") SELECT "createdDate", "modifiedDate", "deletedDate", "identifier", "created", "modified", "health", "missedHealthChecks", "etag", "dataplaneType", "endpointPrefix", "callbackAddress", "managementAddress", "managementToken", "catalogSynchronization", "role" FROM "temporary_dataplanedetails"`);
