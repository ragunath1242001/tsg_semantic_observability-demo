...
export class Postgres20250206144511 implements MigrationInterface {
    name = 'Postgres20250206144511'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "token_dao" ("created" TIMESTAMP NOT NULL DEFAULT now(), "modified" TIMESTAMP NOT NULL DEFAULT now(), "deleted" TIMESTAMP, "id" SERIAL NOT NULL, "accessToken" character varying NOT NULL, "accessTokenExpiresAt" integer NOT NULL, "refreshToken" character varying, "refreshTokenExpiresAt" integer, "scope" character varying NOT NULL, "clientId" character varying, "userId" integer, "revoked" boolean NOT NULL, CONSTRAINT "PK_126e2df3b842e5abafae4166274" PRIMARY KEY ("id"))`);
    }
