...
export class Sqlite20250206144511 implements MigrationInterface {
    name = 'Sqlite20250206144511'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "token_dao" ("created" datetime NOT NULL DEFAULT (datetime('now')), "modified" datetime NOT NULL DEFAULT (datetime('now')), "deleted" datetime, "id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "accessToken" varchar NOT NULL, "accessTokenExpiresAt" integer NOT NULL, "refreshToken" varchar, "refreshTokenExpiresAt" integer, "scope" varchar NOT NULL, "clientId" varchar, "userId" integer, "revoked" boolean NOT NULL)`);
    }
