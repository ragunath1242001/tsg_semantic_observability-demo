...
export class Sqlite20251022085020 implements MigrationInterface {
    name = 'Sqlite20251022085020'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_data_plane_state_dao" ("identifier" varchar PRIMARY KEY NOT NULL, "details" text NOT NULL)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "temporary_data_plane_state_dao"`);
        await queryRunner.query(`ALTER TABLE "data_plane_state_dao" RENAME TO "temporary_data_plane_state_dao"`);
        await queryRunner.query(`CREATE TABLE "data_plane_state_dao" ("identifier" varchar PRIMARY KEY NOT NULL, "managementToken" varchar NOT NULL, "details" text NOT NULL, "datasetConfig" text)`);
        await queryRunner.query(`INSERT INTO "data_plane_state_dao"("identifier", "details") SELECT "identifier", "details" FROM "temporary_data_plane_state_dao"`);
        await queryRunner.query(`DROP TABLE "temporary_data_plane_state_dao"`);
