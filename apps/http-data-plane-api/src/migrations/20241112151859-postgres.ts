...
export class Postgres20241112151859 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "data_plane_state_dao" ("identifier" character varying NOT NULL, "managementToken" character varying NOT NULL, "details" text NOT NULL, "datasetConfig" text, "dataset" text NOT NULL, CONSTRAINT "PK_08b95c167b2cd0e9ac9fa0574c6" PRIMARY KEY ("identifier"))`);
