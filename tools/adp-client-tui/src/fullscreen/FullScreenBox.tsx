...
import { useScreenSize } from "./index.js";

export type BoxProps = ComponentPropsWithoutRef<typeof Box>;

export const FullScreenBox: React.ForwardRefExoticComponent<
  BoxProps & React.RefAttributes<DOMElement>
> = forwardRef<DOMElement, BoxProps>(function FullScreenBox(props, ref) {
