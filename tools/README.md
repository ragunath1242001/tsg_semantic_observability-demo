...
The TSG CLI tool is an utility tool that helps to configure and deploy the TSG components.

For an example with steps to use the CLI tool see the [docs page](../docs/deployment/README.md).
